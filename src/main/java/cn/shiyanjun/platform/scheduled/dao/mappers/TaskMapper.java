...
public interface TaskMapper {
    ...
    @Select("SELECT id,job_id AS jobId,status,serial_no AS serialNo,task_type AS taskType,params," +
            "result_count AS resultCount,start_time AS startTime,done_time AS doneTime FROM task WHERE job_id=#{jobId} ORDER BY serialNo ")
